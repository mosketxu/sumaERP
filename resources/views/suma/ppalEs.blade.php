            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="align-items-center">
                        <img src="{{asset('img/milkovi-444287-unsplashRedim.jpg')}}" alt="Reunion" class="img-fluid rounded-circle">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-2">
                    <div class="align-items-center">
                        <img src="{{ asset('img/business-cellphone-chess-910330Redim.jpg') }}" alt="clip" class="img-fluid rounded-circle">
                    </div>
                </div>
    ...
    <section id="fiscal-section" class="p-3 bloqueSeccion">
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-2">
                    <div class="align-items-center">
                        <img src="{{ asset('img/apple-brainstorming-business-908288redim.jpg') }}" alt="clip" class="img-fluid rounded-circle">
                    </div>
                </div>
                <div class="col-md-6 mb-3 order-1">
    ...
    <section id="mercantil-section" class="p-3 bloqueSeccion">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="align-items-center">
                        <img src="{{ asset('img/adult-agreement-beard-541525redim.jpg') }}" alt="clip" class="img-fluid rounded-circle">
                    </div>
                </div>
